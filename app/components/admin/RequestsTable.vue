      ...
      <div class="overflow-hidden rounded-lg border border-gray-800">
        <table class="min-w-full text-sm text-left">
          ...
          <tbody class="divide-y divide-gray-800">
            <tr>
              <td class="px-6 py-4 text-white font-medium">Alpha Project</td>
              <td class="px-6 py-4 text-gray-300">nizarcad</td>
              <td class="px-6 py-4 text-gray-300">100000</td>
              <td class="px-6 py-4 text-gray-300">2026-01-05</td>
              <td class="px-6 py-4 text-gray-300">Medium</td>
              <td class="px-6 py-4">
                <span
...
<script setup>
import RequestDetailsSidebar from "./RequestDetailsSidebar.vue";
